...
<section class="deals-section sec-pad">
    <div class="auto-container">
        <div class="sec-title">
            ...
            <p><strong> These in-demand listings are attracting quick interest for their prime locations or great value.
                    Don’t
                    miss your chance—act fast!</strong></p>
        </div>
        ...
        <div class="more-btn centred mt-4"><a href="{{ route('all.properties') }}" class="theme-btn btn-one">View All
                Listing</a>
        </div>
    </div>
</section>
