            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                    <div class="footer-widget about-widget">
                        ...
                        <div class="text">
                            <p>Gojo Property connects property owners and seekers in a simple, secure, and efficient way.</p>
                            <p> Whether buying, selling, or renting, we streamline the process in one smart platform.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
