                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="text-center mt-3 mb-4">Gojo Package</h4>
                                            <i data-feather="gift" class="text-success icon-xxl d-block mx-auto my-3"></i>
                                            <h1 class="text-center">ETB 1,200</h1>
                                            ...
                                            {{-- Commission Notice --}}
                                            <p class="text-danger text-center mt-3" style="font-size: 14px;">
                                                * A 10% commission will be charged on each property price you post.
                                            </p>
                                ...
                                <div class="col-md-4 stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h1 class="text-center">ETB 3,000</h1>
                                            <p class="text-muted text-center mb-4 fw-light">Unlimited Months</p>
