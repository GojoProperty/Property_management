                        ...
                        <div class="card-body">
                            ...
                            <div class="container-fluid w-100">
                                <p class="text-danger mt-4">
                                    <strong>Note:</strong> A <strong>10% commission</strong> will be added to the price of
                                    every property you post using this plan. This commission will be applied when setting
                                    your property price
                                </p>
