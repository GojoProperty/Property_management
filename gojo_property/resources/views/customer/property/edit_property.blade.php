                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('customer.update.property') }}" id="myForm"
                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="submit" class="btn btn-primary px-4"
                                                            value="Update Image">
                                                        <a href="{{ route('customer.delete.property.multiimage', $img->id) }}"
                            ...
                            <form method="post" action="{{ route('customer.store.new.multiimage') }}" id="myForm"
                                enctype="multipart/form-data">
                                @csrf
