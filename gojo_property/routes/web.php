...
Route::post('/add-to-wishlist/{property_id}', [WishlistController::class, 'AddToWishList']);Route::get('/all-properties', [FrontendPropertyController::class, 'AllProperties'])->name('all.properties');
